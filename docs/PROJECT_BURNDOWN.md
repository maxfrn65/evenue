...
**Consommé à ce jour** : **22 J/H**
**Reste à faire (RAF)** : **49 J/H**
...
| Lot 5 | Frontend SvelteKit & UI | 12 | 11 | 1 | 🚀 En cours |
| Lot 6 | Réservation & Séquestre Financier | 10 | 3 | 7 | 🚀 En cours |
...
| **TOTAL** | | **71 J/H** | **27 J/H** | **44 J/H** | **En progression** |
...
|---|---|---|---|---|---|---|
| **CU-013** | Gestion des Plages de Disponibilité Hôte, Filtre de Recherche & DatePicker Shadcn | Lot 5 / 6 | 2 J/H | Thomas Moreau | `to do` | `86caw1vq2` |
