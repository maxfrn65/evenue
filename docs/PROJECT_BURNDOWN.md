...
**Consommé à ce jour** : **6 J/H**  
**Reste à faire (RAF)** : **65 J/H**  
...
| Lot 2 | UI/UX Design & Design System | 8 | 2 | 6 | 🚀 En cours |
| Lot 3 | Backend & BDD PostgreSQL/Prisma | 12 | 2 | 10 | 🚀 En cours |
| Lot 4 | Auth & KYC (Stripe Connect) | 6 | 2 | 4 | 🚀 En cours |
| Lot 5 | Frontend SvelteKit & UI | 12 | 0 | 12 | ⏳ En attente |
| Lot 6 | Réservation & Séquestre Financier | 10 | 0 | 10 | ⏳ En attente |
...
| **TOTAL** | | **71 J/H** | **11 J/H** | **60 J/H** | **En progression** |
...
| **CU-002** | Setup Design System & Composants UI Evenue (Geist, Wakam Banner) | Lot 2 | 2 J/H | 2 J/H | Julie Dupuis | `complete` | [#1](https://github.com/maxfrn65/evenue/pull/1) | `main` |
